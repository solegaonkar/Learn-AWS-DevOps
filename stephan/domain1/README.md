...
## Code Commit
- Host your git repositories here - instead of on GitHub.
- Connect using the IAM user. You can setup the SSH access in the IAM console, also configure HTTPS access keys.
...
## Reference Links
Here are all the links that are visited during this section.
